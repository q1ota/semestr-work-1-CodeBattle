...
<head>
  ...
  <title>Регистрация - CodeBattle</title>
...
<body class="min-h-screen bg-primary text-white font-mono tracking-wider">
  <div id="register-page" class="min-h-screen flex items-center justify-center p-4">
    <form method="post" action="${pageContext.request.contextPath}/register" autocomplete="off" class="form w-full max-w-md">
      ...
      <div class="control block-cube block-input mb-6">
        <input name="username" placeholder="Имя пользователя" type="text"
               ...
               required class="w-full px-4 py-3 bg-transparent text-white outline-none">
      ...
      <div class="control block-cube block-input mb-6">
        <input name="confirmPassword" placeholder="Подтвердите пароль" type="password" required class="w-full px-4 py-3 bg-transparent text-white outline-none">
        <div class="bg-top"><div class="bg-inner"></div></div>
        <div class="bg-right"><div class="bg-inner"></div></div>
        <div class="bg"><div class="bg-inner"></div></div>
      </div>

      <button type="submit" class="btn block-cube block-cube-hover w-full mb-4">
        <div class="bg-top"><div class="bg-inner"></div></div>
        <div class="bg-right"><div class="bg-inner"></div></div>
        <div class="bg"><div class="bg-inner"></div></div>
      ...
      <button type="button" onclick="window.location='${pageContext.request.contextPath}/login'" class="btn block-cube block-cube-hover w-full">
        <div class="bg-top"><div class="bg-inner"></div></div>
        <div class="bg-right"><div class="bg-inner"></div></div>
        <div class="bg"><div class="bg-inner"></div></div>
        <div class="text py-3">Назад к входу</div>
      </button>
